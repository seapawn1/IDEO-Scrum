# DesignSprint of Human and Agent

## Challenge

- Input：——
- 过程：human and agent 直接定义当前挑战宣言。
...
- Input：Challenge.md
- 过程：human and agent 直接定义当前 Goal and Questions。
...
- Input：Challenge.md 与 DesignMapping.md
- 过程：对整个地图上的HMW进行观察，敲定最终的Target分段，然后进行分段研究。文件结构：target goal and questions, target map and HMW。
...
- Output：TargetMapping-1.md and Target-Mapping-2.md ......

## Ideate

- Input：Challenge.md 与 TargetMapping-n.md
- 过程：Ideate 研究方法论，比如闪电演示，头脑风暴等等，指导多 Agent 完成，总体是先发散再收敛，收敛到 Map 上。主 Agent 作为主力，subagent 辅助；主 Agent 总是双倍 subagent 权力；最后交给 decider 决定，形成 sketches 方案文档。细节可能是，多agent-->idea池-->sketches池-->decider选定。
