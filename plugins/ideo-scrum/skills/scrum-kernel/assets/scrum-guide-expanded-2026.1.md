...
> **Version:** v2026.1 (Latest) | **Updated:** January 18, 2026
> **Contributors:** John Coleman, Ralph Jocham, Jeff Sutherland
> **Based on:** [2020 Scrum Guide](https://scrumguides.org/scrum-guide.html) by Ken Schwaber & Jeff Sutherland
>
> **License:** Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)
> (c) 2025 Ralph Jocham, John Coleman, and Jeff Sutherland.
>
...
>
> **Source:** [Scrum Guide Expanded - January 2026](https://scrumexpansion.org/scrum-guide-expanded/2026.1/)
...
This Scrum Guide Expansion Pack(SGEP) explains the what and why of each element of Scrum for the current times. Each element serves a specific purpose and contributes to the overall value and results realized with Scrum. This Expansion Pack will evolve regularly. The reader is expected to read the document sequentially, at least the first time.
...
Supporting Stakeholders, hereafter referred to as Supporters, doing what is requested to proactively support and enhance the adoption of Scrum, guided and supported by the Scrum Master. (SG2020 mentions stakeholder 14 times, never defines it)
A Product Owner sets the Product Goal, instrumental in fulfilling Stakeholder value.
The self-managing Scrum Team [11] defines, refines, and turns the selection of work into valuable outcomes.
The Scrum Team and Stakeholders inspect the results during the Sprint and adapt.
Supporters help the Scrum Team to thrive (SG2020 Supporter is not a concept).
Repeat.
...
Product thinking [31-33] deals with the tension [25] that Products often need to Focus on growth in the short-term but also need to address long-term concerns, e.g., gaining traction with early adopters, ‘crossing the chasm’ [34], expanding, updating Product versions, continuous change, customer lifetime value and total cost of ownership.
...
Product Owners need to master the handling of trade-offs between the here and now and the anticipated future (the there and then) [35] through courage, humility, consultation, collaboration, healthy conflict, etc.
...
Encouraging the Scrum Team to Focus on the core drivers of effectiveness, adaptiveness [37], and timeliness -such as autonomy, transparency, and adaptation- rather than blindly following processes or copying what others have done.
...
The Scrum Team addresses all Product-related activities, from Stakeholder collaboration to value validation, including verification, maintenance, operation, experimentation, research and development, and anything else that might be required. The Scrum Team instills quality. Supporters ensure the organization structures the climate and the work environment and empowers the Scrum Team to self-manage [11]. Working in Sprints at a sustainable pace improves Focus and consistency.
...
Scrum was developed in the early 1990s. Ken Schwaber and Jeff Sutherland first co-presented Scrum at the OOPSLA Conference in 1995 [60]. The first version of the Scrum Guide  [7] appeared in 2009. Scrum is evolving.
...
[10] Scrum.org (2025) Scrum Hexis. Available at: https://thecynefin.co/product/hexi-scrumorg/?srsltid=AfmBOorcohLYeVy0qBsQFI6mK_bZtJA_uGC6hPL2BdptiTwNmMwpKTQv  (Accessed: 17 May 2025).
...
[12] Cynefin.io  , V. (2022) Cynefin wiki, Cynefin.io  . Cynefin.io  . At: https://cynefin.io/  (Accessed: April 4, 2023).
...
[47] Stripe (2025) ‘Sir Jony Ive and Patrick Collison Fireside Chat | Stripe Sessions 2025’, YouTube video, 8 May. Available at: https://youtu.be/wLb9g_8r-mE?si=1rEJxU0sxixvblQ3&t=1390  (Accessed: 8 June 2025)
