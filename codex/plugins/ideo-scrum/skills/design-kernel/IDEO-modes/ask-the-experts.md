...
Most of Monday afternoon is a series of one-at-a-time interviews with people from your sprint team, from around your company, and possibly outsiders with special knowledge. As you go, each team member takes notes individually — gathering the information needed to choose the sprint target, and fuel for Tuesday's sketches.

The authors learned this lesson the hard way. In one sprint, the CEO assured them the map was "absolutely, one hundred percent" right. Then Wendy — the sales lead — walked in. She pointed to the diagram and explained exactly what customers would say at each step: "I've never heard of this company. Why should I trust you with my account number?" Within minutes, she had changed almost every part of the map. The map was accurate before Wendy came in. It was just more accurate afterward. She put the basic facts into a real customer's context.
